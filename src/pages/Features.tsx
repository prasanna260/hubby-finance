  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
              ...
              <div key={categoryIndex} className="mb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {category.features.map((feature, featureIndex) => (
                    <Card key={featureIndex} className="bg-card border border-border shadow-md hover:shadow-lg transition-shadow duration-300">
                      <CardHeader>
        ...
        {/* CTA section */}
        <section className="py-16 px-6 md:px-10 lg:px-20 bg-card border-t border-border">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" size="lg" className="border-input text-foreground hover:bg-accent">
                Schedule a Demo
              </Button>
            </div>
          </div>
