  ...
  return (
    <div className="min-h-screen bg-white">
      <main>
        ...
        <section className="bg-gradient-to-br from-navy-50 via-white to-emerald-50 py-16 md:py-24 px-6 md:px-10 lg:px-20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Link to="/sign-up">
                <Button size="lg" variant="outline" className="border-navy-600 text-navy-700">
                  Get Started Free
                </Button>
              </Link>
            </div>
              ...
              {gettingStarted.map((step) => (
                <div key={step.number} className="text-center">
                  <div className="relative mb-6">
                    <div className="bg-white rounded-full w-20 h-20 flex items-center justify-center mx-auto shadow-lg">
                      {step.icon}
                    </div>
                    <div className="absolute -top-2 -right-2 bg-emerald-600 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">
                      {step.number}
                    </div>
                  </div>
        ...
        <section className="py-16 px-6 md:px-10 lg:px-20">
          <div className="max-w-7xl mx-auto">
            ...
            <Tabs defaultValue="dashboard" className="w-full">
              <TabsList className="grid grid-cols-3 lg:grid-cols-6 gap-2 h-auto p-2 bg-gray-100">
                {features.map((feature) => (
                  <TabsTrigger 
                    key={feature.id} 
                    value={feature.id}
                    className="flex flex-col gap-2 py-3 data-[state=active]:bg-white data-[state=active]:shadow-md"
                  >
                    {feature.icon}
                  ...
                  <Card className="mt-6">
                    ...
                    <CardContent>
                      <div className="grid md:grid-cols-2 gap-8">
                        <div>
                          <h4 className="font-semibold text-navy-900 mb-4">How to Use It:</h4>
                          <div className="space-y-4">
                            {feature.howItWorks.map((step, index) => (
                              <div key={index} className="flex gap-3">
                                ...
                                <div>
                                  <p className="font-medium text-navy-900">{step.step}</p>
                        ...
                        <div>
                          <h4 className="font-semibold text-navy-900 mb-4">Key Benefits:</h4>
        ...
        <section className="py-16 px-6 md:px-10 lg:px-20 bg-gradient-to-br from-emerald-50 to-blue-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-900 text-center mb-12">
        ...
        {/* CTA Section */}
        <section className="py-16 px-6 md:px-10 lg:px-20 bg-gradient-to-r from-navy-700 to-emerald-600">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Link to="/dashboard">
              <Button size="lg" className="bg-white/20 border-2 border-white text-white hover:bg-white hover:text-navy-700 transition-all">
                Explore Dashboard
              </Button>
              </Link>
            </div>
